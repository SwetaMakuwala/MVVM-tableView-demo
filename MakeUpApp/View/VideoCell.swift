...
class VideoCell: UITableViewCell {
    ...
    func set(meme: Meme){
        ...
        imageDisplay(url: meme.url) { outputData in
            self.videoImageView.image = UIImage(data: outputData)
        }

        
    }
    func imageDisplay(url: String, completion : ((_ outputData: Data) -> Void)? = nil){
